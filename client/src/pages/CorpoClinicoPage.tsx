          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {doctors.map((doctor) => {
              ...
              return (
                ...
                >
                  {/* Botão de Share */}
                  <div className="absolute top-4 right-4" ref={shareMenuOpen === doctor.id ? shareMenuRef : null}>
                    <button
                  ...
                  <div className="flex-grow mb-4">
                    ...
                    {needsExpand && (
                      ...
                      >
                        {isExpanded ? t('clinicalTeam.viewLess') : t('clinicalTeam.viewMore')}
                      </button>
                    )}
                  </div>
      ...
      <footer className="bg-gray-900 text-white py-8 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-gray-400">
            &copy; 2025 Centro Dentário Colombo. {t('clinicalTeam.footerRights')}
          </p>
