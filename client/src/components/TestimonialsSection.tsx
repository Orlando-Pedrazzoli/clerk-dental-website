...
const TestimonialCard = ({ name, initials, rating, timeAgo, text, googleUrl, viewOnGoogleLabel }: TestimonialCardProps) => (
  <div className="p-5 rounded-xl mx-4 shadow-md hover:shadow-xl transition-all duration-300 w-80 shrink-0 bg-white border border-gray-100">
    ...
    >
      ...
      <div className="flex items-center gap-1.5">
        <span className="text-gray-400 group-hover:text-blue-600 transition-colors">{viewOnGoogleLabel}</span>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-blue-50 px-4 py-2 rounded-full mb-4">
              ...
              <span className="text-sm font-semibold text-gray-700">{t('testimonials.googleReviews')}</span>
            </div>
            ...
            <div className="inline-flex items-center gap-3 bg-white px-6 py-3 rounded-full shadow-md">
              ...
              <span className="text-sm text-gray-600">
                {t('testimonials.basedOn')} <span className="font-semibold text-gray-900">{googleTestimonials.length}+ {t('testimonials.reviews')}</span>
              </span>
            </div>
